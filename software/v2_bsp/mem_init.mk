...
# Memory: ram_onchip_memory
MEM_0 := t_vga_v1_ram_onchip_memory
$(MEM_0)_NAME := ram_onchip_memory
...
$(MEM_0)_HIERARCHICAL_PATH := ram_onchip_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: ram_onchip_memory
ram_onchip_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
