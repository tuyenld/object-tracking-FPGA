...
SOPCINFO_FILE := D:/2.SET/1.Doc/Nam4/Sem1/ThietKeTongHopICSo/1.Project/ICSo/Tuyen/tuyen_vga_v1/t_vga_v1.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9130
SOPC_SYSID_FLAG += --sidp=0x9130
ELF_PATCH_FLAG  += --sidp 0x9130

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1448245385
SOPC_SYSID_FLAG += --timestamp=1448245385
ELF_PATCH_FLAG  += --timestamp 1448245385
